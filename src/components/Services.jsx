...
export default function Services() {
  return (
    <section id="service" className="py-20 bg-gray-50 text-gray-900">
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-primary/10 px-3 py-1 text-sm text-primary">My Services</div>
          ...
          <p className="max-w-[700px] text-gray-500 md:text-lg">
            My services encompass both frontend and backend development, ensuring a seamless experience for users.
          </p>
        </div>
...
function ServiceCategory({ title, icon, description }) {
  return (
    <div className="flex flex-col items-center text-center p-6 rounded-lg bg-white border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
...
function ServiceItem({ title }) {
  return (
    <div className="flex items-center p-3 rounded-lg border border-gray-200 bg-gray-100 hover:bg-white transition-colors">
